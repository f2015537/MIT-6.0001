...
class PhraseTrigger(Trigger):
    ...
    def is_phrase_in (self,text):
         ...
         text_lower_list = list(filter(lambda a: a != '', text_lower_list))
         for i in range(len(text_lower_list)-1):
              builder = text_lower_list[i]
              for j in range(i+1,len(text_lower_list)):
                  if builder==phrase_lower:
                      return True
                  builder = builder + " " + text_lower_list[j]
              if builder==phrase_lower:
                  return True
         return False
